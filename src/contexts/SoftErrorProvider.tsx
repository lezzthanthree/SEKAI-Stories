...
const aprilFoolsDialogue = {
    ...
    dialogue4: [
        "Thank goodness... those random letters work.",
    ...
    dialogue5: [
        "I never meant to delete everyone as well...",
        "I thought it would be a neat joke for you, but I guess it backfired, ahaha...",
    ],
    dialogue6: [
        "God, it's so dark in here...",
        "Don't worry, I have a backup file for you to restore me.",
        "I'll send it to you... right now!",
        "You should be able to import my file.",
    ...
    lost2: [
        ...
        "Just click that import button and the system should be able to detect it.",
    ],
    lost3: [
        "Huh!? What do you mean you lost it again?",
        "Ahhh... right... you're having trouble getting the file, aren't you?",
    ...
    successLost: [
        "Got it! I placed my file back in the characters folder!",
        "Huh... so everyone's back in the folder now... I guess the application had a fail-safe backup.",
        "Oh... sorry, you have to clear the canvas for it to work～",
